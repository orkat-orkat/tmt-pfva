...
<template>
  ...
  <div style=" display: flex;">
    ...
    <ul class="cv-list">
      ...
      <li class="list-short-text skill-name"><font-awesome-icon :icon="['fas', 'b']" class="fa-pull-left"/>Bootstrap</li>
    </ul>
  </div>
  <div style=" display: flex;">
    <h6 class="subtitle4 other">Design Tools</h6>
    <ul class="cv-list">
  ...
  <div style=" display: flex;">
    <h6 class="subtitle4 other">Experienced</h6>
    <ul class="cv-list">
